            ...
            <div class="col-12">
              <div class="card top-selling overflow-auto">
                ...
                <div class="card-body pb-0">
                  <h5 class="card-title">News <span>| Today</span></h5>
                  ...
                  <table class="table table-borderless">
                    ...
                    <tbody>
                      <?php foreach ($CabinetNews as  $NewsList){?>
                      <tr>
                        <th scope="row"><a href="#"><img src="assets/img/NEWS/<?=$NewsList['img']?>" alt=""></a></th>
                        <td><a href="#" class="text-primary fw-bold"><?=$NewsList['text']?></a></td>
                        <td><?=$NewsList['text']?></td>
                        <td class="fw-bold"><?=$NewsList['datee']?></td>
                        <td><a href="/cabinet/delete/<?=$NewsList['id']?>" class="btn btn-danger">Delete</a></td>
